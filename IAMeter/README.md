...
Таблица ниже суммирует, какие CWE инструменты «нашли» при сопоставлении SARIF. Ключ *«—»* — анализатор к языку этого репозитория не запускался.
